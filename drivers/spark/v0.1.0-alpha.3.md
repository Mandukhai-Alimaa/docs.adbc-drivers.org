...
(driver-spark-v0.1.0-alpha.3)=
# Apache Spark Driver v0.1.0-alpha.3

[{badge-primary}`Driver Version|v0.1.0-alpha.3`](#driver-spark-v0.1.0-alpha.3 "Permalink") {badge-secondary}`Release Date|2026-07-10` {badge-success}`Tested With|Spark 3.x 3.5-livy` {badge-success}`Tested With|Spark 3.x 3.5-thrift` {badge-success}`Tested With|Spark 4.x 4.0-connect` {badge-success}`Tested With|Spark 4.x 4.0-thrift` {badge-success}`Tested With|Spark 4.x 4.0-thrifthttp`
...
timestamp[us] (with time zone) ⚠️ [^3], timestamp[us] ⚠️ [^3]
...
[^6]: Negative scales are not supported
