...
(driver-quack-v0.1.0-alpha.1)=
# DuckDB Quack Driver v0.1.0-alpha.1

{badge-primary}`Driver Version|0.1.0-alpha.1` {badge-secondary}`Release Date|2026-05-21` {badge-success}`Tested With|DuckDB Quack 1.5`
